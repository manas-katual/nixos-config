...
#Everforest
def everforest():
	colors = [["#272e33", "#272e33"],  #background (dark grey) [0]
			  ["#859289", "#859289"],  #light grey [1]
			  ["#d3c6aa", "#d3c6aa"],  #foreground (beige) [2]
			  ["#7fbbb3", "#7fbbb3"],  #blue/grey) [3]
			  ["#83c092", "#83c092"],  #blue [4]
			  ["#a7c090", "#a7c090"],  #green [5]
			  ["#e69875", "#e69875"],  #orange [6]
			  ["#d699b6", "#d699b6"],  #pink [7]
			  ["#dbbc7f", "#dbbc7f"],  #green [8]
			  ['#e67e80', '#e67e80'],  #red [9]
			  ["#384b55", "#384b55"],  #beige [10]
			  ["#2e383c", "#2e383c"],  #beige [10]
			  ["#2e383c", "#2e383c"]]  #beige [11]
...
def cozytile():
	colors = [["#232634", "#232634"],  #background (dark grey) [0]
			   ...
			   ["#1e1e2e", "#1e1e2e"],  #light grey [1]
			   ["#313244", "#313244"],  #light grey [1]
			   ["#181825", "#181825"],  #light grey [1]
...
#black and white
def black():
	colors = [["#1d1f21", "#1d1f21"],   # dark green [0]
			   ["#c5c8c6", "#c5c8c6"],  # pink [1]
			   ["#c5c8c6", "#c5c8c6"],  # green [2]
			   ["#c5c8c6", "#c5c8c6"],  # yellow [3]
			   ["#c5c8c6", "#c5c8c6"],  # blue [4]
			   ["#c5c8c6", "#c5c8c6"],  # purple [5]
			   ["#c5c8c6", "#c5c8c6"],  # blue [6]
			   ["#c5c8c6", "#c5c8c6"],  # blue [6]
			   ["#c5c8c6", "#c5c8c6"],  # white [7]
			   ["#c5c8c6", "#c5c8c6"],  # white [7]
			   ["#c5c8c6", "#c5c8c6"],  # orange  [8]
			   ["#c5c8c6", "#c5c8c6"],  #red [9]
			   ["#c5c8c6", "#c5c8c6"]]  #yellow [10]
			   
	backgroundColor = "#1d1f21"
	foregroundColor = "#c5c8c6"
	workspaceColor = "#c5c8c6"
	foregroundColorTwo = "#c5c8c6"
	return colors, backgroundColor, foregroundColor, workspaceColor, foregroundColorTwo

def bottom():
	colors = [["#1e222a", "#1e222a"],  # Background, 0
			["#abb2bf", "#abb2bf"],  # Foreground, 1
			["#565c64", "#565c64"],  # Lighter Background, 2
			["#e06c75", "#e06c75"],  # Red, 3
			["#98c379", "#98c379"],  # Green, 4
			["#e5c07b", "#e5c07b"],  # Yellow, 5
			["#61afef", "#61afef"],  # Blue, 6
			["#c678dd", "#c678dd"],  # Magenta, 7
				["#56b6c2", "#56b6c2"]]  # Cyan, 8

	backgroundColor = "#1e222a"
	foregroundColor = "#abb2bf"
	workspaceColor = "#1e222a"
	foregroundColorTwo = "#abb2bf"
	return colors, backgroundColor, foregroundColor, workspaceColor, foregroundColorTwo

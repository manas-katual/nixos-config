...
in {
  config = lib.mkIf (config.wlwm.enable && !config.sway.enable && (userSettings.style == "waybar-cool" || userSettings.style == "waybar-ddubs" || userSettings.style == "waybar-jerry" || userSettings.style == "waybar-nekodyke" || userSettings.style == "waybar-simple")) {

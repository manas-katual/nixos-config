  		...
  		programs.wlogout = {
				...
				style = ''
					...
					* {
					...
					/** ********** Icons ********** **/
					#lock {
						background-image: url("/home/smaalks/setup/modules/nixos/wlogout/icons/lock.png");
						border-radius: 25px 0px 0px 0px;
						margin : 35px 0px 0px 10px;
					}

					#logout {
						background-image: url("/home/smaalks/setup/modules/nixos/wlogout/icons/shutdown.png");
						border-radius: 0px 0px 0px 25px;
						margin : 0px 0px 35px 10px;
					}

					#shutdown {
						background-image: url("/home/smaalks/setup/modules/nixos/wlogout/icons/reboot.png");
						border-radius: 0px 25px 0px 0px;
						margin : 35px 10px 0px 0px;
					}

					#reboot {
						background-image: url("/home/smaalks/setup/modules/nixos/wlogout/icons/logout.png");
